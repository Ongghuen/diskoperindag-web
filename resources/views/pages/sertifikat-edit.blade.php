            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Form edit sertifikat</h4>
                        <form class="forms-sample" action="/sertifikat-update/{{ $item->id }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-default" id="exampleInputUsername1"
                                    placeholder="No Sertifikat" name="no_sertifikat" value="{{ $item->no_sertifikat }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control input-default" id="exampleInputEmail1"
                                    name="tanggal_terbit" placeholder="Tanggal Terbit" value="{{ $item->tanggal_terbit }}">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control input-default" id="exampleInputEmail1"
                                    ...
                                    value="{{ $item->kadaluarsa_penyelenggara }}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Keterangan</label>
                                <textarea class="form-control input-default" id="exampleTextarea1" rows="4" name="keterangan">{{ $item->keterangan }}</textarea>
                            </div>
