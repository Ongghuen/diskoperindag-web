...
@section('tagline')
    Tambah item ke data Sertifikat.
@endsection
...
@section('content')
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Form tambah Item Sertifikat</h4>
                <form class="forms-sample" action="/sertifikat-add-item" method="POST" enctype="multipart/form-data">
                    @csrf
